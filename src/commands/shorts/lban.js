...
class LBanCommand extends Command {
    constructor(context, options) {
        super(context, {
            ...
            aliases: ['lightban'],
            description:
                'Calls the vcban command on the light of the world guest room.',
    ...
    async chatInputRun(interaction) {
        return runVcShortcut(interaction, this.container, '1353551552945590272');
    }
