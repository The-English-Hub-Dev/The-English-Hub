...
class HUnbanCommand extends Command {
    constructor(context, options) {
        super(context, {
            ...
            aliases: ['healthunban'],
            description:
                'Calls the vcunban command on the mental health cafe guest room.',
    ...
    async messageRun(message, args, ctx) {
        ...
        message.content = `${ctx.prefix}vcunban 1375597364890308770 ${member.id} ${reason}`;
    ...
    async chatInputRun(interaction) {
        return runVcShortcut(interaction, this.container, '1375597364890308770', true);
    }
