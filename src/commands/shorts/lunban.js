...
class LUnbanCommand extends Command {
    constructor(context, options) {
        super(context, {
            ...
            aliases: ['lightunban'],
            description:
                'Calls the vcunban command on the light of the world guest room.',
    ...
    async chatInputRun(interaction) {
        return runVcShortcut(interaction, this.container, '1353551552945590272', true);
    }
